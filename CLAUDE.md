...
**Character customisation — rebuilt, and it began with a real production crash.** One deliberately reopened product area; everything else stays frozen.
...
`docs/CHARACTER_CUSTOMISATION_BOUNDARY.md` is the canonical account.
