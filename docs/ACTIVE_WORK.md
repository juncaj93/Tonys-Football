...
|---|---|---|---|---|
| Loot-box reveal impact | codex/loot-reveal-impact | Stepped pixel-particle arrival treatment, reveal timing, reduced-motion parity, and visual QA evidence | Reward odds, token balance, counter purchase rules, collectible art, rooms, and casino mechanics | 2026-08-23 |
