...
> **Implementation is gated.** No code changes follow from this document until (a) the eight open questions in §13 receive a Technical Lead ruling, (b) PR #8 is merged or otherwise reconciled, and (c) a fresh implementation branch is cut from the resulting `main`.
