...
export function ShowInteractables() {
  ...
  return (
    <button
      type="button"
      onClick={reveal}
      className="flex h-11 min-w-[44px] shrink-0 items-center justify-center px-2 font-mono text-[10px] whitespace-nowrap text-ink-100/45 transition-colors active:text-amber-mid"
    >
      look around
    </button>
  );
